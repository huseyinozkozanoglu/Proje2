...
namespace Staj2.Infrastructure.Migrations
{
    ...
    [Migration("20260514113932_AddPermissionOrderIndex")]
    partial class AddPermissionOrderIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Staj2.Domain.Entities.Computer", b =>
                {
                    ...
                    b.Property<bool>("IsOfflineAlertSent")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Staj2.Domain.Entities.ComputerMetric", b =>
                {
                    ...
                    b.HasIndex("ComputerId", "CreatedAt");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ComputerId", "CreatedAt"), new[] { "CpuUsage", "RamUsage" });
            ...
            modelBuilder.Entity("Staj2.Domain.Entities.DiskMetric", b =>
                {
                    ...
                    b.HasIndex("ComputerDiskId", "CreatedAt");
            ...
            modelBuilder.Entity("Staj2.Domain.Entities.MetricWarningLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ComputerId", "MetricTypeId", "CreatedAt");

                    b.ToTable("MetricWarningLogs");
                });
            ...
            modelBuilder.Entity("Staj2.Domain.Entities.Permission", b =>
                {
                    ...
                    b.HasIndex("SidebarItemId");

                    b.ToTable("Permissions");
                });

            modelBuilder.Entity("Staj2.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Staj2.Domain.Entities.SidebarItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Staj2.Domain.Entities.MetricWarningLog", b =>
                {
                    ...
                    b.HasOne("Staj2.Domain.Entities.MetricType", "MetricType")
                        .WithMany()
            ...
            modelBuilder.Entity("Staj2.Domain.Entities.Permission", b =>
                {
                    b.HasOne("Staj2.Domain.Entities.SidebarItem", "SidebarItem")
                        .WithMany()
                        .HasForeignKey("SidebarItemId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("SidebarItem");
                });
            ...
            modelBuilder.Entity("Staj2.Domain.Entities.SidebarItem", b =>
                {
                    b.HasOne("Staj2.Domain.Entities.SidebarItem", "Parent")
                        .WithMany("Children")
