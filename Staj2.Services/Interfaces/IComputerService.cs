...
public interface IComputerService
{
    ...
    Task<ServiceResult<object>> GetMetricsHistoryBatchAsync(List<int> ids, string start, string end, int? maxPoints = null);
    ...
    Task<ExportTokenParams?> GetExportParamsAsync(string token);
}